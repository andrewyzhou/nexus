...
(function () {
  ...
  function renderSummary(data) {
    ...
    const prose = escapeHtml(data.summary);
  ...
  window.renderAISummary = async function renderAISummary({ kind, key }) {
    const wrap = document.getElementById('ai-summary');
